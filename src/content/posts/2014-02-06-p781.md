...
titleZh: 'AMC官网给出的剧中出现过的歌单列表'
titleEn: 'AMC''s Official Song List from the Show'
descriptionZh: '转载：AMC官网整理的《绝命毒师》全五季每集配乐歌单。'
descriptionEn: 'A repost of AMC''s official episode-by-episode song list for all five seasons of Breaking Bad.'
---
