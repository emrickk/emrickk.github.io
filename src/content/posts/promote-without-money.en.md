...
1) It genuinely solves a concrete problem. Example: Didi Dache

2) Proven capacity for self-driven growth. Example: WeChat

3) A value chain or revenue model whose logic holds together. Example: Bilibili.
