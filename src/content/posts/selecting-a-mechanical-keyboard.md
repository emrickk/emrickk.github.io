---
title: 'Shopping Mechanical Keyboards'
description: 'A buyer''s guide to mechanical keyboards: switches, sizes, wired versus wireless, and the brands worth buying.'
pubDate: '2020-11-22'
category: 'Prodigal'
lang: 'en'
...
Here is a very good article to start with: [link](https://www.mechanical-keyboard.org/switch-types/). You can only read the Cherry black, red, blue, and brown parts, those four are the most popular ones.
...
My next keyboard is definitely iQunix! Just check the [website](https://iqunix.store/) out.
...
I tried [this one](https://www.logitech.com/en-us/product/k845-mechanical-illuminated?crid=27#section-product-hero) (in Logitech blue switch) in a Bestbuy store, and the feeling is almost as good as my Filco.
